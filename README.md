...
* [Step 1: Upload the Deployment Package to AWS Lambda](#step-1-upload-the-deployment-package)
...
Pair your Echo Buttons to your Amazon Echo device, and then invoke the skill by saying _**“Alexa, open Hello Buttons”**_. The skill should run as described in the [skill flow](#hello-buttons-skill-flow).
