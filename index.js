 ...
 **/
 ...
 const main = {
    ...
    */
     ...
     */
     ...
     // Have Alexa say something in the standard way.
      this.response.speak("Welcome to the Gadgets Test Skill. Press your Echo Buttons to change the colors of the lights. <audio src='https://s3.amazonaws.com/ask-soundlibrary/foley/amzn_sfx_rhythmic_ticking_30s_01.mp3'/>");
   ...
   'AMAZON.HelpIntent': function() {
     ...
     this.response.speak("Welcome to the Gadgets Test Skill. Press your Echo Buttons to change the lights. <audio src='https://s3.amazonaws.com/ask-soundlibrary/foley/amzn_sfx_rhythmic_ticking_30s_01.mp3'/>");
     delete this.handler.response.response.shouldEndSession;
     console.log(JSON.stringify(this.handler.response));
     this.emit(':responseReady');
   },
   ...
   'Unhandled': function() {
     ...
     this.response.speak("Sorry, I didn't get that.  Please press your Echo Buttons to change the color of the lights. <audio src='https://s3.amazonaws.com/ask-soundlibrary/foley/amzn_sfx_rhythmic_ticking_30s_01.mp3'/>");
     delete this.handler.response.response.shouldEndSession;
     console.log(JSON.stringify(this.handler.response));
     this.emit(':responseReady');
   }
